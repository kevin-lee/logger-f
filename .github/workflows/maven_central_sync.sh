...
if [ "${GITHUB_TAG:-}" != "" ]; then
  ...
  BINTRAY_PACKAGES="logger-f-core logger-f-slf4j logger-f-log4s logger-f-log4j logger-f-sbt-logging logger-f-cats-effect logger-f-monix logger-f-scalaz-effect"
