...
trait Logful {
  ...
  def debugEither[F[_] : LoggerEither, A, B](fab: F[A \/ B])(a2String: A => String, b2String: B => String): F[A \/ B] =
    LoggerEither[F].debugEither(fab)(a2String, b2String)

  def infoEither[F[_] : LoggerEither, A, B](fab: F[A \/ B])(a2String: A => String, b2String: B => String): F[A \/ B] =
    LoggerEither[F].infoEither(fab)(a2String, b2String)

  def warnEither[F[_] : LoggerEither, A, B](fab: F[A \/ B])(a2String: A => String, b2String: B => String): F[A \/ B] =
    LoggerEither[F].warnEither(fab)(a2String, b2String)

  def errorEither[F[_] : LoggerEither, A, B](fab: F[A \/ B])(a2String: A => String, b2String: B => String): F[A \/ B] =
